...
/*
    public static final class Curve implements Cloneable{
        ...
        public void fromString(String str) {
            ArrayList<Float> xp = new ArrayList<>();
            ArrayList<Float> yp = new ArrayList<>();
    ...
    */
    ...
    protected void paintLabel(Graphics2D g2d) {
        ...
        edu.oregonstate.carto.mapcomposer.gui.CenteredStringRenderer.drawCentered(g2d, this.label,
                size.width / 2, (int)(size.height * 0.4),
                edu.oregonstate.carto.mapcomposer.gui.CenteredStringRenderer.NOFLIP);
    }
